<?php
/**
 * Template 3 HTML - Enhanced Casino/Slots Template with Hero Section
 * 
 * Variables available:
 * - All $fields and $option_fields variables are extracted and available
 * - $hero_title, $hero_subtitle, $hero_rating - Enhanced hero section fields
 * - $main_content - Repeater field for content blocks
 * 
 * @package kaziki
 */
...
<head>
    ...
    <style>
        ...
        * {
        ...
        h1, h2, h3, h4, h5, h6 {
            ...
            text-align: <?php echo $position_title; ?>;
        }
        ...
        .<?php echo $c['btn_primary']; ?> {
            ...
            border: 2px solid <?php echo $btn_bg; ?>;
    ...
    min-width: 320px;
        ...
        .<?php echo $c['hero_section']; ?> {
            position: relative;
            margin-bottom: 30px;
        }
         .<?php echo $c['hero_section']; ?> img{
            width: 100%;
           min-height: 450px;
         }
        .<?php echo $c['hero_content']; ?> {
         position: absolute;
        top: 0;
        left: 0;
        text-align: center;
    ...
    <main>
            ...
            <div class="<?php echo $c['main_wrapper']; ?>">
                  <div class="<?php echo $c['hero_section']; ?>">
                    ...
                    <?php if (!empty($hero_title) || !empty($hero_subtitle) || !empty($hero_rating)): ?>
                        <div class="<?php echo $c['hero_content']; ?>">
                             
                            <?php if (!empty($hero_rating)): ?>
                                <div class="<?php echo $c['hero_rating']; ?>">★★★★★ <?php echo esc_html($hero_rating); ?></div>
                            <?php endif; ?>
                            <?php if (!empty($hero_title)): ?>
                                <h1 class="<?php echo $c['hero_title']; ?>"><?php echo esc_html($hero_title); ?></h1>
                            <?php endif; ?>
                            
                            <?php if (!empty($hero_subtitle)): ?>
                                <p class="<?php echo $c['hero_subtitle']; ?>"><?php echo esc_html($hero_subtitle); ?></p>
                            <?php endif; ?>
                            
                            <?php if (!empty($hero_button_text)): ?>
                                <a href="<?php echo esc_url($link); ?>" class="btn"><?php echo esc_html($hero_button_text); ?></a>
                            <?php endif; ?>
            ...
            <div class="<?php echo $c['content_area']; ?>">
                ...
                <!-- Main Content Repeater -->
                <div class="<?php echo $c['container']; ?>">
                    <?php if (!empty($main_content) && is_array($main_content)): ?>
                        <?php foreach ($main_content as $content_block): ?>
                            <div class="<?php echo $c['content_block']; ?>">
                                <?php echo $content_block['content'] ?? ''; ?>
                            </div>
                        <?php endforeach; ?>
                    <?php elseif (!empty($content_text)): ?>
                        <!-- Fallback to single content field if repeater is empty -->
